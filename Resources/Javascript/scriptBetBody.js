...
var userName = window.prompt("Benvenuto!\nInserisci il tuo nome:", "");

// Variabile per l'importo totale (credito)
var totalAmount = parseFloat(window.prompt("Inserisci il tuo credito iniziale:", 0));

document.getElementById('title').textContent = "Benvenuto " + userName + "!";
...
function placeBet(sceltaPlayer) {
    ...
    if(totalAmount==0){
        alert("Non hai credito per scommettere, devi ricaricare la pagina!");
        return;
    }else{
